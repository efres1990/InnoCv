...
public class EditActivity extends BaseActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // button.
        Fragment fragment = getSupportFragmentManager().findFragmentById(R.id.layout_edit_content);
        if (fragment != null) {
    ...
    private void configureFragments(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            getSupportFragmentManager()
                    ...
                    .add(R.id.layout_edit_content, EditFragment.newInstance(), EditFragment.TAG)
